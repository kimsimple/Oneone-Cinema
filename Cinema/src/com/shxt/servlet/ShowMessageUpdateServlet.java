...
@WebServlet("/backstage/ShowMessageUpdateServlet.do")
public class ShowMessageUpdateServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//修改指令
			...
			System.out.println("start_timeE"+request.getParameter("idE"));
