...
<script type="text/javascript">
	...
	function search() {
		...
		pageForm.action="MovieQueryServlet.do?oper=listISHot";
	...
	function del(id){
		var d = dialog({
		    ...
		    height:'200px',
		    ok: function () {
		    	self.location="MovieUpdateServlet.do?oper=dealNotHot&idDel="+id;
		    },
		    cancelValue: '取消',
		    cancel: function () {
									...
									<tr id="${vs.count }">
										...
										<%-- <td>
										 ...
										 <td>
											...
											<a href="javascript:void(0);" onclick="del(${stu.id })" >取消热映</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
