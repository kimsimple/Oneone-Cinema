	...
	<div class="xs">
		...
		<div class="tab-content">	
			<div class="tab-pane active" id="horizontal-form">
				<form id="formHall" enctype="multipart/form-data"  class="form-horizontal" >
					<div class="form-group">
						<label for="focusedinput" class="col-sm-2 control-label">座位数:
							</label>
						<div class="col-sm-8">
							<input type="text" name="seat_numA" class="form-control1" 
								placeholder="座位数">
						</div>
					</div>
					...
					<div class="form-group">
						<label for="focusedinput" class="col-sm-2 control-label">
							大厅描述:</label>
						<div class="col-sm-8">
							<input type="text" name="desprictionA" class="form-control1"
								placeholder="大厅描述">
						</div>
					</div>
					...
					<div class="panel-footer">
						<div class="row">
							<div class="col-sm-8 col-sm-offset-2" style="text-align:right;">
								...
								<input class="btn-success btn" type="button" value="确认添加" onclick="jump()"> 
								</div>
							</div>
						</div>
					</form>
