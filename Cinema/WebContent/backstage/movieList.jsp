									...
									<tr id="${vs.count }">
										...
										<%-- <td>
										 ...
										 <td>
											...
											<a href="javascript:void(0);" onclick="del(${stu.id })" >删除</a><br>
											 <a href="MovieUpdateServlet.do?oper=setIsHot&idMMM=${stu.id }" >
										 	设为热映 &nbsp;
										 	</a>
										 	<a href="MovieUpdateServlet.do?oper=setComingSoon&idMM=${stu.id }" >
										 	设为即将上映 &nbsp;
										 	</a>
										 	<a href="MovieUpdateServlet.do?oper=setPlate&idM=${stu.id }" >
										 	设为面板 &nbsp;
