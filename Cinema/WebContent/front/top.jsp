				 ...
				 <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					...
					<nav>
						<ul class="nav navbar-nav">
							<li class="active" ><a href="<%=path %>/front/index.jsp">电影首页</a></li>
							<!-- <li class="dropdown">
							...
							<li><a href="<%=path %>/front/ShowMessageFrontQueryServlet.do?oper=listSchedule">电影排期</a></li>
